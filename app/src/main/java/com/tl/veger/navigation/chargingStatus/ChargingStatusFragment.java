...
//    chargeNeedTimeList.addAll(TimeProc((int) needTime));
    ...
    if (batteryManager.computeChargeTimeRemaining() > 0) {
      double timeRemaining = batteryManager.computeChargeTimeRemaining() / 1000.0/60;
      chargeNeedTimeList.addAll(TimeProc((int) timeRemaining));
      ...
      double chargeTime = hour * 60 + min + timeRemaining;
