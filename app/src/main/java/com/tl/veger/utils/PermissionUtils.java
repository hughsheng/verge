        ...
        switch (permissionCode) {
            ...
            case REQUEST_BLUETOOTH:
                if (ActivityCompat.checkSelfPermission(activity, Manifest.permission.BLUETOOTH) != PackageManager.PERMISSION_GRANTED ||
                    ...
                    ActivityCompat.requestPermissions(activity, PERMISSION_BLUETOOTH, REQUEST_BLUETOOTH);
                } else {
                  ret = true;
                }
                checkBluetooth();
            ...
            case REQUEST_CALL:
                if (ActivityCompat.checkSelfPermission(activity, Manifest.permission.READ_CALL_LOG) != PackageManager.PERMISSION_GRANTED ||
                        ActivityCompat.checkSelfPermission(activity, Manifest.permission.WRITE_CALL_LOG) != PackageManager.PERMISSION_GRANTED) {
