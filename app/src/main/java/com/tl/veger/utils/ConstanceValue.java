...
public class ConstanceValue {
    ...
    public static final String SEND_CHARACTERISTIC = "00001526-1212-EFDE-1523-785FEABCD123";//往该特征值写入数据
    public static final String OBSERVE_CHARACTERISTIC = "00001527-1212-EFDE-1523-785FEABCD123";//监听该特征值触发写入
    ...
    public static int UNREAD_MAIL;//邮件未读数
    public static int CURRENT_BATTERY_PERCENT;//当前手机电量
    public static boolean IS_CHARGING = false;//是否在充电
    public static DataProtocolUtil.MSG_TYPE curentType;//当前发送的消息类型
