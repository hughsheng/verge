...
public class ConstanceValue {
	...
	public static boolean currentIs24HourFormat = false;

	//Gmail相关
	public static Gmail mService;
	public static final String PREF_ACCOUNT_NAME = "accountName";
	public static final String[] SCOPES = {GmailScopes.GMAIL_LABELS/*, GmailScopes
  .MAIL_GOOGLE_COM, GmailScopes.GMAIL_READONLY, GmailScopes.GMAIL_MODIFY*/};
	...
	public static boolean isLoginGmail = false;
