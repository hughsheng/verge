...
public class GoogleLoginActivity extends AppCompatActivity implements PermissionUtils.PermissionListener{
    ...
    private static final String[] SCOPES = {GmailScopes.GMAIL_LABELS/*, GmailScopes.MAIL_GOOGLE_COM, GmailScopes.GMAIL_READONLY, GmailScopes.GMAIL_MODIFY*/};
    ...
    private boolean isGooglePlayServicesAvailable() {
        int connectionStatusCode = GoogleApiAvailability.getInstance().isGooglePlayServicesAvailable(this);
